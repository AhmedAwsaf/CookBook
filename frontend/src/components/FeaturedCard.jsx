...
const FeaturedCard = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto mb-20 mt-12">
      ...
      <div className="bg-orange-50 text-teal-500 rounded-lg overflow-hidden shadow-lg grid grid-cols-[0.4fr_1fr]">
        ...
        <div className="p-6 flex flex-col">
              ...
              <div className="flex items-center text-sm justify-between">
                ...
                <div className="flex gap-3">
                  {recipe?.tags?.map((tag) => (
                    <spans
                      key={tag}
                      className="py-2 px-4 font-medium text-sm rounded-full shadow-md hover:shadow-lg transition duration-300 bg-[#f0f5c4] text-[#59871f]"
                    >
                      {tag}
                    </spans>
                  ))}
          ...
          <div className="mt-auto pt-4 border-t border-teal-500 border-opacity-20">
            <div className="flex justify-between items-center">
              <span className="text-sm">Difficulty: {recipe?.difficulty}</span>
              <button
                className="px-4 py-2 font-semibold text-sm rounded-full bg-teal-600 hover:bg-teal-500 text-slate-100"
                onClick={openModal}
              >
                View Recipe
              </button>
